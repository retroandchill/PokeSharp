...
void UPokeSharpNameExporter::GetOrAddEntry(const UTF16CHAR *Str,
                                           const int32 Length,
                                           const bool FindMode,
...
bool UPokeSharpNameExporter::EqualsBuffer(const uint32 ComparisonIndex,
                                          const uint32 DisplayIndex,
                                          const int32 Number,
                                          const UTF16CHAR *Str,
                                          const int32 Length)
{
...
void UPokeSharpNameExporter::GetString(const uint32 ComparisonIndex,
                                       const uint32 DisplayIndex,
                                       const int32 Number,
                                       FString &OutString)
{
...
void UPokeSharpNameExporter::FromUnrealName(const FName Name,
                                            uint32 &ComparisonIndex,
                                            uint32 &DisplayIndex,
                                            int32 &Number)
{
