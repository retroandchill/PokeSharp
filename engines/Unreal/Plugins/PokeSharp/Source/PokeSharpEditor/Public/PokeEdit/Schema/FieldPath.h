...
namespace PokeEdit
{
    ...
    struct FListIndexSegment
    {
        ...
        static constexpr auto JsonSchema = TJsonObjectType(
                std::in_place_type<FListIndexSegment>, std::make_tuple(TJsonField<&FListIndexSegment::Index>(TEXT("index"))));
    };
    ...
    struct FDictionaryKeySegment
    {
        ...
        static constexpr auto JsonSchema = TJsonObjectType(
                std::in_place_type<FDictionaryKeySegment>, std::make_tuple(TJsonField<&FDictionaryKeySegment::Key>(TEXT("key"))));
    };
    ...
    struct TJsonUnionTraits<FFieldPathSegment>
    {
        static constexpr auto JsonSchema = TJsonUnionType(
            ...
            TJsonUnionKey<FPropertySegment,
                          FFieldPathSegment::IndexOfType<FPropertySegment>()>(TEXT("Property")),
            TJsonUnionKey<FListIndexSegment,
                        FFieldPathSegment::IndexOfType<FListIndexSegment>()>(TEXT("ListIndex")),
            TJsonUnionKey<FDictionaryKeySegment,
                        FFieldPathSegment::IndexOfType<FDictionaryKeySegment>()>(TEXT("DictionaryKey")));
    };
