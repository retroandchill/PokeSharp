...
[GameDataRegistration<GrowthRate>]
[RegisterSingleton<IGameDataProvider<GrowthRate>>]
public partial class GrowthRateRegistrations
{
    private const string LocalizationNamespace = "GameData.GrowthRate";

    // csharpier-ignore-start
    [GameDataEntityRegistration]
    internal static readonly GrowthRate Medium = new() {
        Id = "Medium", // Also known as Medium Fast
        Name = Text.Localized(LocalizationNamespace, "Medium", "Medium"),
        ExpValues =
        [
            -1,
        ...
        ExpFormula = level => (int)Math.Pow(level, 3)
    };

    [GameDataEntityRegistration]
    internal static readonly GrowthRate Erratic = new() {
        Id = "Erratic",
        Name = Text.Localized(LocalizationNamespace, "Erratic", "Erratic"),
        ExpValues =
        [
            -1,
        ...
        ExpFormula = level => (int)Math.Pow(level, 4) + (int)Math.Pow(level, 3) * 2000 / 3500
    };

    [GameDataEntityRegistration]
    internal static readonly GrowthRate Fluctuating = new() {
        Id = "Fluctuating",
        Name = Text.Localized(LocalizationNamespace, "Fluctuating", "Fluctuating"),
        ExpValues =
        [
            -1,
        ...
        ExpFormula = level => ((int)Math.Pow(level, 3) + level / 2 + 32) * 4 / (100 + level)
    };

    [GameDataEntityRegistration] internal static readonly GrowthRate Parabolic = new() {
        Id = "Parabolic",
        Name = Text.Localized(LocalizationNamespace, "Parabolic", "Parabolic"),
        ExpValues =
        [
            -1,
    ...
    [GameDataEntityRegistration] internal static readonly GrowthRate Fast = new() {
        Id = "Fast",
        Name = Text.Localized(LocalizationNamespace, "Fast", "Fast"),
        ExpValues =
        [
            -1,
        ...
        ExpFormula = level => (int)Math.Pow(level, 3) * 4 / 5
    };

    [GameDataEntityRegistration] internal static readonly GrowthRate Slow = new() {
        Id = "Slow",
        Name = Text.Localized(LocalizationNamespace, "Slow", "Slow"),
        ExpValues =
        [
            -1,
        ...
        ExpFormula = level => (int)Math.Pow(level, 3) * 5 / 4
    };
