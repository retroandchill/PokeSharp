...
{
    private static readonly Dictionary<Name, INameOptionsSource> Sources = new()
    {
    ...
    public static (int Count, IEnumerable<Name> Names) GetNameOptions(Name name) => Sources[name].Options;
}
